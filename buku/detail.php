...
$query1 = mysqli_query($kon, "SELECT * FROM buku_perpus WHERE buku_perpus.id_buku = '$id' ");

$query = mysqli_query($kon, "SELECT * FROM buku_perpus INNER JOIN kategori USING(id_kategori) WHERE buku_perpus.id_buku = '$id' ");
...
<body>
        ...
        <div class="container">
            ...
            <div class="card-header">
                <?php while($judul_buku=mysqli_fetch_assoc($query1)): ?>
            <h2 class="card-title"><?= $judul['judul_buku']?></h2>
                <?php endwhile; ?>
