...
$sql = "SELECT * FROM peminjaman_perpus p INNER JOIN detail_pinjam dp ON p.id_pinjam=dp.id_pinjam INNER JOIN buku_perpus b ON b.id_buku=dp.id_buku where p.id_pinjam='$id_pinjam'";
