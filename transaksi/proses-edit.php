...
if(isset($_POST['tgl_kembali'])){
	...
	mysqli_query($kon, "UPDATE peminjaman_perpus SET tgl_pinjam='$tgl_pinjam' WHERE id_pinjam=$id_pinjam");	 
}else{
	mysqli_query($kon, "UPDATE peminjaman_perpus SET tgl_pinjam='$tgl_pinjam' WHERE id_pinjam=$id_pinjam");	 
}
...
if($count == 1){
	...
	echo $denda;
	$sql = "UPDATE peminjaman_perpus SET denda=$denda WHERE id_pinjam=$id_pinjam";
